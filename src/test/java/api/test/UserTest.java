...
public class UserTest {
    ...
    public void testGetUser(){
       ...
       Response response =  UserEndPoints.get_user(this.payloadUser.getUsername());
       response.then().log().all();
       Assert.assertEquals(response.getStatusCode(),200);
    ...
    public void testUpdateUser(){
        ...
        Response response =  UserEndPoints.put_user(payloadUser, this.payloadUser.getUsername());
        response.then().log().all();
        Assert.assertEquals(response.getStatusCode(),200);

        // check after update
        Response updatedResponse = UserEndPoints.post_user(payloadUser);
    ...
    public void deleteUser(){
        ...
        Response response = UserEndPoints.delete_user(this.payloadUser.getUsername());
       response.then().log().all();
       Assert.assertEquals(response.getStatusCode(),200);
